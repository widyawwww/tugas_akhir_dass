...
<div class="p-4 sm:ml-64">
    <div class="mt-14 space-y-6">
        ...
        <div class="p-4 bg-white rounded-lg shadow-lg flex justify-between items-center">
            <p class="text-lg font-semibold">Jadwal Konsultasi Konselor</p>
            <a href="#" class="bg-blue-500 rounded-lg px-2 py-1 text-white hover:bg-blue-600 text-sm"
               data-modal-target="modalTambahJadwalKonselor" data-modal-toggle="modalTambahJadwalKonselor">
                ...
                <table class="w-full bg-white rounded-lg shadow-lg">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="p-3 text-sm">{{ $item->konselor->nama_lengkap ?? '-' }}</td>
                            ...
                            <td class="p-3 text-sm text-center whitespace-nowrap">
                                ...
                                <button class="text-blue-600 hover:underline text-sm"
                                    data-modal-target="modalEditJadwalKonselor-{{ $item->id }}"
                                    data-modal-toggle="modalEditJadwalKonselor-{{ $item->id }}">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </button>

                                <!-- Form Hapus -->
                                <form action="{{ route('admin.jadwal-konselor.destroy', $item->id) }}"
...
@include('components.modal.tambahJadwalKonselor')
@include('components.modal.editJadwalKonselor')
@endsection
