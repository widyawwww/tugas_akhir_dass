...
<div class="p-4 sm:ml-64">
    <div class="mt-14 space-y-6">
        ...
        <div class="p-4 bg-white rounded-lg shadow-lg flex justify-between items-center">
            <p class="text-lg font-semibold">Jadwal Konsultasi Psikolog Klinis</p>
            <div class="flex space-x-2">
                <a href="{{ route('admin.jadwal-psikolog-klinis.generate') }}"
                ...
                <a href="#" class="bg-blue-500 rounded-lg px-2 py-1 text-white hover:bg-blue-600 text-sm"
                   data-modal-target="modalTambahJadwalPsikologKlinis" data-modal-toggle="modalTambahJadwalPsikologKlinis">
                ...
                <table class="w-full bg-white rounded-lg shadow-lg">
                    <thead>
                        <tr class="bg-gray-100 text-left text-gray-600 text-sm font-semibold">
                            <th class="p-3">No</th>
                            <th class="p-3">Psikolog Klinis</th>
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="p-3 text-sm">{{ $item->psikologklinis->nama_lengkap ?? '-' }}</td>
                            ...
                            <td class="p-3 text-sm text-center whitespace-nowrap">
                                ...
                                <button class="text-blue-600 hover:underline text-sm"
                                    data-modal-target="modalEditJadwalPsikologKlinis-{{ $item->id }}"
                                    data-modal-toggle="modalEditJadwalPsikologKlinis-{{ $item->id }}">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </button>

                                <!-- Form Hapus -->
                                <form action="{{ route('admin.jadwal-psikolog-klinis.destroy', $item->id) }}"
...
@include('components.modal.tambahJadwalPsikologKlinis')
@include('components.modal.editJadwalPsikologKlinis')
@endsection
